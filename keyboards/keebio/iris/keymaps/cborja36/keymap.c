...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		...
		KC_LCTL, KC_MEH, KC_LSFT, KC_LALT, KC_LGUI, KC_NO,                                      KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_CAPS, KC_NO, 
	...
	[3] = LAYOUT(
		...
		KC_NO, KC_COLN, KC_DLR, KC_PERC, KC_CIRC, KC_PLUS,                                     KC_NO, KC_LGUI, KC_LALT, KC_LSFT, KC_MEH, KC_LCTL, 
